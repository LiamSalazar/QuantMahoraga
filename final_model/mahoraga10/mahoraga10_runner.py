...
from mahoraga10_data import load_inputs
from mahoraga10_backtest import run_walk_forward_mahoraga10
from mahoraga10_reporting import build_final_report_text, save_outputs
from mahoraga10_utils import ensure_dir


def run_mahoraga10(make_plots_flag: bool = False, run_mode: str = "FAST") -> Dict[str, Any]:
    ...
    wf = run_walk_forward_mahoraga10(ohlcv, cfg, costs, universe_schedule)
...
if __name__ == "__main__":
    run_mahoraga10(make_plots_flag=False, run_mode="FAST")
