...
def build_shared_state(
    ...
    out["gross_long_native"] = long_book_fold["gross_long"].reindex(idx).fillna(0.0)
    ...
    out["continuation_relief"] = clip01(out["continuation_pressure"] * (1.0 - out["structural_fragility"]) * (1.0 - out["benchmark_weakness"]))
