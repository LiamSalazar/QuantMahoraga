...
def run_mahoraga14_3(make_plots_flag: bool = False, run_mode: str = "FAST") -> Dict[str, Any]:
...
run_mahoraga14_2 = run_mahoraga14_3
run_mahoraga14 = run_mahoraga14_3


if __name__ == "__main__":
    run_mahoraga14_3(make_plots_flag=False, run_mode="FAST")
