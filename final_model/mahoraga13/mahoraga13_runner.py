...
from mahoraga13_backtest import run_walk_forward_mahoraga13
from mahoraga13_config import Mahoraga13Config
from mahoraga13_data import load_inputs
from mahoraga13_reporting import build_final_report_text, save_outputs
from mahoraga13_utils import ensure_dir


def run_mahoraga13(make_plots_flag: bool = False, run_mode: str = "FAST") -> Dict[str, Any]:
    ...
    wf = run_walk_forward_mahoraga13(ohlcv, cfg, costs, universe_schedule)
...
if __name__ == "__main__":
    run_mahoraga13(make_plots_flag=False, run_mode="FAST")
