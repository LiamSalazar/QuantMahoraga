...
def build_full_report_text(wf: Dict[str, Any], cfg: Mahoraga13Config) -> str:
...
def save_full_outputs(wf: Dict[str, Any], cfg: Mahoraga13Config, ff=None) -> Dict[str, pd.DataFrame]:
    ...
    trace_df.to_csv(f"{cfg.outputs_dir}/stitched_test_trace_full.csv", index=False)
