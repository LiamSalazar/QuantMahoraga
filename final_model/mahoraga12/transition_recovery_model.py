...
from mahoraga12_utils import time_split_index
...
def fit_transition_model(train_weekly: pd.DataFrame, cfg: Mahoraga12Config, outer_parallel: bool) -> Dict[str, Any]:
...
def fit_recovery_model(train_weekly: pd.DataFrame, cfg: Mahoraga12Config, outer_parallel: bool) -> Dict[str, Any]:
    return _fit_time_model(
        train_weekly,
        RECOVERY_FEATURES,
        "recovery_y",
