...
def build_fast_report_text(wf: Dict[str, Any], cfg: Mahoraga12Config) -> str:
    ...
    lines = [
        ...
        f"  M12  vs Base   p-value={paired_ttest_pvalue(model_r - base_r, alternative='greater'):.6f}",
        f"  M12  vs Legacy p-value={paired_ttest_pvalue(model_r - legacy_r, alternative='greater'):.6f}",
