...
from mahoraga12_backtest import run_walk_forward_mahoraga12
from mahoraga12_config import Mahoraga12Config
from mahoraga12_data import load_inputs
from mahoraga12_reporting import build_final_report_text, save_outputs
from mahoraga12_utils import ensure_dir


def run_mahoraga12(make_plots_flag: bool = False, run_mode: str = "FAST") -> Dict[str, Any]:
    ...
    wf = run_walk_forward_mahoraga12(ohlcv, cfg, costs, universe_schedule)
...
if __name__ == "__main__":
    run_mahoraga12(make_plots_flag=False, run_mode="FAST")
