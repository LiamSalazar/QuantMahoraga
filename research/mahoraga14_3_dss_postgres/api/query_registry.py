...
QUESTIONS = [
    ...
    {"id": "performance-extreme-outcomes", "question": "Does performance depend on a small number of extreme outcomes?", "endpoint": "/research/distributions", "facts": ["dw.fact_outcome"], "operations": ["roll-up"]},
    ...
    {"id": "decision-backoff-missed-upside", "question": "Backoff decisions with missed upside.", "endpoint": "/research/olap-preset", "facts": ["mart.mv_decision_outcome"], "operations": ["slice"]},
