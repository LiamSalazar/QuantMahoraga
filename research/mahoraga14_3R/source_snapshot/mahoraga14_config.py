...
class Mahoraga14Config(m6.Mahoraga6Config):
    variant: str = "14.3R"
    label: str = "MAHORAGA_14_3R_ACCEPTANCE"
    cache_dir: str = field(default_factory=lambda: str(_project_root() / "data_cache"))
    outputs_dir: str = field(default_factory=lambda: str(_project_root() / "mahoraga14_3R_outputs"))
    plots_dir: str = field(default_factory=lambda: str(_project_root() / "mahoraga14_3R_plots"))
    official_baseline_label: str = "BASE_ALPHA_V2"
    historical_benchmark_label: str = "LEGACY"
    model_label: str = "M14_3R_ACCEPTANCE"
    ...
    acceptance_budget_multipliers: Tuple[float, ...] = (0.95, 1.00, 1.05)
    acceptance_conviction_multipliers: Tuple[float, ...] = (0.90, 1.00, 1.10)
    acceptance_leader_multipliers: Tuple[float, ...] = (0.90, 1.00, 1.10)
    acceptance_backoff_multipliers: Tuple[float, ...] = (0.95, 1.00, 1.05)
    acceptance_priority_windows: Tuple[str, ...] = ("2017_2018", "2020_2021", "2023_2024")
    acceptance_bootstrap_samples: int = 300
    acceptance_bootstrap_block: int = 20
    acceptance_model_selection_bootstrap_samples: int = 200
