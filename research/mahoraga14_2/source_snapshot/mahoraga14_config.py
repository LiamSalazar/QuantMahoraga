...
class Mahoraga14Config(m6.Mahoraga6Config):
    ...
    participation_long_budget_floor: float = 0.72
    participation_long_budget_base: float = 0.88
    participation_long_budget_ceiling: float = 1.00
    participation_gate_max: float = 1.30
    participation_vol_mult_max: float = 1.22
    participation_exp_cap_max: float = 1.35
    participation_leader_blend_max: float = 0.60
    participation_mix_lift: float = 0.20
    participation_beta_penalty_mult: float = 0.15
    participation_raw_rel_boost_lift: float = 0.28
    participation_cash_redeploy_scale_cap: float = 1.65
    participation_max_name_weight: float = 0.78
    participation_redeploy_headroom_floor: float = 0.04
    risk_backoff_budget_floor: float = 0.65
    risk_backoff_hard_budget: float = 0.45
    risk_backoff_gate_floor: float = 0.94
    risk_backoff_vol_floor: float = 0.95
    risk_backoff_exp_floor: float = 0.90
    risk_backoff_hard_break_risk: float = 0.80
    risk_backoff_hard_fragility: float = 0.80
    risk_backoff_hard_benchmark_weakness: float = 0.78
